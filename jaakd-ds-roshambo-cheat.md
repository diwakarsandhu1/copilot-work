---
layout: index
title: "Rock Paper Scissors: Cheat Mode"
heading: "Rock Paper Roshambo in JavaScript"
subheading: "Cheat Mode"
description: "Roshambo on Cheat Mode"
user-story: "As a player, I want to see what gesture the computer will play before I choose so that I can guarantee a win every round."
---
...
games = JSON.parse(localStorage.getItem('games')) || [];
    ...
    document.getElementById('cheat').innerHTML = 'Computer will play: ' + serverGesture;
